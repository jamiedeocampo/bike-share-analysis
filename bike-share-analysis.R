...
setwd("/Users/YOUR_USERNAME/Desktop/Divvy_Exercise/csv") #sets working directory to simplify calls to data
...
write.csv(counts, "C:\\Users\\JAMIE\\Desktop\\avg_ride_length.csv", row.names=FALSE)
